...
import { mergeProps, ref, withCtx, createVNode, unref, createTextVNode, createBlock, createCommentVNode, toDisplayString, openBlock, h, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderVNode } from 'vue/server-renderer';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4"><p class="text-white/60 text-sm"> \xA9 2025 Yuktrix. All rights reserved. </p><div class="flex gap-6 text-sm"><a href="#" class="text-white/60 hover:text-[#FEE337] transition-all">Privacy Policy</a><a href="#" class="text-white/60 hover:text-[#FEE337] transition-all">Terms of Service</a></div></div></div></footer>`);
    };
  }
};
...
//# sourceMappingURL=default-D-7GXTRL.mjs.map
