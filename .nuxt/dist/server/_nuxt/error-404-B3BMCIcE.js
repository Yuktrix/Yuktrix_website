...
import { u as useHead } from "./v3-DQlyTy40.js";
...
import "D:/yuktrix/node_modules/.pnpm/@unhead+vue@2.0.19_vue@3.5.25/node_modules/@unhead/vue/dist/index.mjs";
const _sfc_main = {
  __name: "error-404",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-dd3d886d><div class="fixed left-0 right-0 spotlight z-10" data-v-dd3d886d></div><div class="max-w-520px text-center z-20" data-v-dd3d886d><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-dd3d886d>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-dd3d886d>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-dd3d886d>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.1_@parcel+watcher_18f5d98705a61230f034495fcf32d104/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd3d886d"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-B3BMCIcE.js.map
